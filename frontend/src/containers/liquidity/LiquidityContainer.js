...
import SwapDivider from "../../components/shared/SwapDivider";
    ...
    <Container>
      ...
      >
        ...
        <ResponsiveContainer>
          <Input
            leftLabel="input"
            bottomLabel={`balance: ${reduceBalance(fromValues.balance) ?? "-"}`}
          ...
          <Input
            leftLabel="input"
            bottomLabel={`balance: ${reduceBalance(toValues.balance) ?? "-"}`}
            placeholder="enter amount"
            inputRightComponent={
              toValues.coin ? (
                <InputToken
